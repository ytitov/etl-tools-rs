...
sourcesIndex["etl_core"] = {"name":"","dirs":[{"name":"datastore","dirs":[{"name":"mock","files":["mock_csv.rs"]},{"name":"sources","files":["mod.rs","string.rs"]}],"files":["enumerate.rs","error.rs","fs.rs","mock.rs","mod.rs","simple.rs"]},{"name":"decoder","files":["csv.rs","json.rs","string.rs"]},{"name":"queue","files":["mod.rs"]},{"name":"task","files":["apply.rs","mod.rs","pipeline.rs"]},{"name":"utils","files":["log.rs"]}],"files":["batch.rs","decoder.rs","encoder.rs","joins.rs","lib.rs","splitter.rs","transformer.rs","utils.rs"]};
